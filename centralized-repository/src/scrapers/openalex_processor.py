                ...
                try:
                    ...
                    if expert_data:
                        ...
                        expert_row = {
                            ...
                            'OpenAlex_ID': expert_data['openalex_id'],
                            'Domains': '|'.join(expert_data['domains']),
                            'Fields': '|'.join(expert_data['fields']),
                            'Subfields': '|'.join(expert_data['subfields'])
                        }
                        experts_enriched.append(expert_row)
                        
                        # Process publications
                        if expert_data['openalex_id']:
                            pubs = await self.get_expert_works(
                                session, 
                                expert_data['openalex_id']
                            )
                            for pub in pubs:
